    ...
    <div className="flex flex-col items-center gap-10 w-full">
      ...
      <div className="relative w-full">
        ...
        <button
          style={{
            ...arrowBase,
            left: isMobile ? "calc(50% - min(36vw, 135px) - 22px)" : "16px",
            width: isMobile ? "38px" : "44px",
            height: isMobile ? "38px" : "44px",
            background: isMobile ? "rgba(196,163,85,0.18)" : "rgba(255,255,255,0.14)",
            border: isMobile ? "1.5px solid rgba(196,163,85,0.55)" : "1.5px solid rgba(255,255,255,0.45)",
            color: isMobile ? CAFE : "#ffffff",
            backdropFilter: isMobile ? "none" : "blur(6px)",
          }}
          onClick={prev} aria-label="Anterior"
          onMouseEnter={e => {
            (e.currentTarget as HTMLElement).style.background = isMobile ? "rgba(196,163,85,0.34)" : "rgba(255,255,255,0.28)";
            (e.currentTarget as HTMLElement).style.borderColor = isMobile ? "rgba(196,163,85,0.80)" : "rgba(255,255,255,0.70)";
          }}
          onMouseLeave={e => {
            (e.currentTarget as HTMLElement).style.background = isMobile ? "rgba(196,163,85,0.18)" : "rgba(255,255,255,0.14)";
            (e.currentTarget as HTMLElement).style.borderColor = isMobile ? "rgba(196,163,85,0.55)" : "rgba(255,255,255,0.45)";
          }}>
        ...
        <button
          style={{
            ...arrowBase,
            right: isMobile ? "calc(50% - min(36vw, 135px) - 22px)" : "16px",
            width: isMobile ? "38px" : "44px",
            height: isMobile ? "38px" : "44px",
            background: isMobile ? "rgba(196,163,85,0.18)" : "rgba(255,255,255,0.14)",
            border: isMobile ? "1.5px solid rgba(196,163,85,0.55)" : "1.5px solid rgba(255,255,255,0.45)",
    ...
    <div className="min-h-[100dvh] flex flex-col" style={{ background: BG, color: TEXT, overflowX: "hidden" }}>
      ...
      <section id="nosotros" className="sgc-nos-section relative overflow-hidden" style={{
        ...
        <style>{`
          ...
          @media (max-width: 640px) {
            ...
            .sgc-nos-lead     { text-align: center !important; font-size: 0.82rem !important; line-height: 1.75 !important; }
      ...
      <section id="contacto" className="relative overflow-hidden" style={{ background: DARK, scrollMarginTop: "72px" }}>
        ...
        <style>{`
          ...
          .sgc-cc2-hour-p     { font-family: 'Cormorant Garamond', serif; font-size: 0.85rem; color: rgba(255,255,255,0.78); line-height: 1.3; text-align: center; }
          .sgc-cc2-divider-line { height: 1px; background: rgba(255,255,255,0.20); margin: 7px 0; width: 100%; }
          .sgc-cc2-item       { padding: 3px 0; display: flex; align-items: flex-start; gap: 8px; text-align: left; }
        ...
        <div className="sgc-cc2-outer">
          ...
          <div className="sgc-cc2-cta">
            <h2 style={{
              ...
              lineHeight: 1.22, marginBottom: "10px",
