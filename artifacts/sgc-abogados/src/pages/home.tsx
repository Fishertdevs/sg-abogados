...
function FaqSection() {
  ...
  return (
    <section className="sgc-faq-section relative overflow-hidden" style={{ backgroundColor: BG }}>
      {/* Ola superior derecha — solo tapa el gap sobre la columna (desktop) */}
      <div className="hidden lg:block" style={{
        position: "absolute", top: 0, left: 0, right: 0, lineHeight: 0, pointerEvents: "none", zIndex: 3,
        maskImage: "linear-gradient(to right, transparent 50%, black 62%)",
        WebkitMaskImage: "linear-gradient(to right, transparent 50%, black 62%)",
      }}>
