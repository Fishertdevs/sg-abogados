        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="sgc-test-img-col relative flex justify-end">
            <div style={{
              ...
              maskImage: "linear-gradient(to bottom, black 55%, transparent 92%), linear-gradient(to right, transparent 0%, black 6%)",
              WebkitMaskImage: "linear-gradient(to bottom, black 55%, transparent 92%), linear-gradient(to right, transparent 0%, black 6%)",
